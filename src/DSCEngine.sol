...
//Inherit later the interface `IDSCEngile`
contract DSCEngine is IDSCEngine, ReentrancyGuard {
     ...
     * @param amountDscToBurn: The amount of decentralized stablecoin you are burning
     ...
     * @param debtToCover The amount of DSC you want to burn to imporve the users health
     * factor.
     ...
     * for this to work.
     * @notice A known bug would be if the protocol were 100% or less collateraized, then we wouldn't   
        ...
        nonReentrant
    {
        ...
        uint256 totalCollateralToRedeem = tokenAmountFromDebtCovered; //+ bonusCollateral; //(there is an overflow bug
            // with this)
    ...
    /*
     * @notice CEI is violated because the transfer needs to occur and then checking
     * the health factor and revert if it doesn't satisfy it. This is safe.
     * @param tokenCollateralAddress: The address of token collateral to be redeemed
